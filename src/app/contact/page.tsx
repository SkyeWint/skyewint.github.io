  ...
  return (
    ...
    >
          ...
          <div className="flex h-75 items-center justify-between bg-[url(/skyfox2.webp)] bg-no-repeat bg-size-[17rem] bg-right">
            <div className="flex flex-col items-center gap-3">
              <p className="text-xl py-2">
                ...
                pictures or a cute animal video?
              </p>
            </div>
      ...
      <section className={`w-full flex justify-center p-8 ${pink}`}>
        <div className="w-3xl text-center text-xl">
          <div>
            Email me directly at{' '}
            <Link href="mailto:skye@skyfoxcoaching.com" target="_blank">
              <u>skye@skyfoxcoaching.com</u>
            </Link>
            !
          </div>
